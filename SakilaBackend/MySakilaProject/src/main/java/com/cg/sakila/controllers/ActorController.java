...
public class ActorController {
	...
	public ResponseEntity<String> updateActorLastName(@Valid @PathVariable("id") int id, @RequestBody String lastName) {
	...
	public ResponseEntity<?> updateActorFirstName(@Valid @PathVariable("id") int id,
	...
	public ResponseEntity<String> assignFilmToActor(@Valid @PathVariable("id") int actorId, @RequestBody Film film) {
	...
	@GetMapping("/byId/{id}")
	public ResponseEntity<Actor> findByActorId(@PathVariable("id") int actorId){
