...
public class FilmController {
	...
	@PutMapping("/admin/update/releaseyear/{id}")
	...
	@PutMapping("/admin/update/rentalduration/{id}")
	...
	@PutMapping("/admin/update/rentalrate/{id}")
	...
	@PutMapping("/admin/update/rating/{id}")
	...
	@PutMapping("/admin/update/category/{categoryid}/film/{id}")
	...
	@GetMapping("/public/rating/{rating}")
