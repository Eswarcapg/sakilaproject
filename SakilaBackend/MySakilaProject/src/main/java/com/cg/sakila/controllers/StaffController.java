...
public class StaffController {
	...
	public Staff searchStaffByEmail(@Valid @PathVariable String email) {
		return staffService.searchStaffByEmail(email);
	}

	@PutMapping("/{id}/address")
	public ResponseEntity<Staff> assignAddressToStaff(@Valid @PathVariable("id") int staffId, @RequestBody Address address) {
		// Get the staff by ID
	...
	public Staff updateStaffFirstName(@Valid @PathVariable int id, @RequestBody Staff staff) {
	...
	public Staff updateStaffLastName(@Valid @PathVariable int id, @RequestBody Staff staff) {
	...
	public Staff updateStaffEmail(@Valid @PathVariable int id, @RequestBody Staff staff) {
	...
	public Staff assignStoreToStaff(@Valid @PathVariable int id, @RequestBody Store store) {
		return staffService.assignStoreToStaff(id, store);
	}

	@PutMapping("/update/phone/{id}")
	public Staff updateStaffPhone(@Valid @PathVariable int id, @RequestBody String phone) {
